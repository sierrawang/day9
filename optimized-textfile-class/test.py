...
def main():
    # Create three OptimizedTextFiles
    ...
    # Load the files information into a dictionary for
    ...
    # Loop through every file stored in the dictionary
    for key in given_dict:
        # Loop through every attribute and check it against the solution
